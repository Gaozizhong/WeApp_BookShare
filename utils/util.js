        ...
        wx.login({
            success: function (res) {
                if (res.code) {
                    //请求access_token
                    wx.request({
                        url: 'http://' + getApp().globalData.apiUrl + '/bookshare?m=home&c=User&a=getSessionKey&code=' + res.code,
                        success: function (res) {
                            ...
                            wx.getUserInfo({
                                success: function (res) {
                                    ...
                                    //创建账号到数据库
                                    wx.request({
                                        url: 'http://' + getApp().globalData.apiUrl + '/bookshare?m=home&c=User&a=regiser&avatarUrl=' + res.avatarUrl + "&city=" + res.city + "&country=" + res.country + "&gender=" + res.gender + "&nickName=" + res.nickName + "&province=" + res.province + "&openId=" + getApp().globalData.openId,
                                        success: function (res) {
