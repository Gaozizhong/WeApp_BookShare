...
Page({
    ...
    onLoad: function (options) {
        ...
        wx.request({
            url: 'http://' + app.globalData.apiUrl + '?m=home&c=Api&a=getEditInfo&canShareId=' + canShareId,
            header: {
    ...
    saveKeepTime:function(e){
        ...
        wx.request({
            url: 'http://' + app.globalData.apiUrl + '?m=home&c=Api&a=editKeepTime&canShareId=' + canShareId + "&keepTime=" + that.data.keepTime + "&book_id=" + that.data.bookId + "&user_id=" + app.globalData.userId +"&book_content=" + that.data.key1 + "&card_content=" + that.data.card_content + "&location=" + that.data.location + "&latitude=" + that.data.latitude + "&longitude=" + that.data.longitude + "&age=" + arrayValue[index],
            header: {
                'content-type': 'application/json'
            },
            success: function (res) {
