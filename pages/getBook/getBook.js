...
Page({
    ...
    onLoad: function () {
        var that = this;
        wx.request({
            url: ('https://' + app.globalData.apiUrl + '?m=home&c=Api&a=getBook&ownerId=' + app.globalData.userId).replace(/\s+/g, ""),
            method: "GET",
            header: {
    ...
    ownerAffirmReturn: function (e) {
        ...
        var that = this;
        wx.request({
            url: ('https://' + app.globalData.apiUrl + '?m=home&c=Api&a=getBookFun&sharingId=' + sharingId).replace(/\s+/g, ""),
            method: "GET",
            header: {
                'content-type': 'application/json'
            },
