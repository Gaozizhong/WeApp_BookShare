                    ...
                    wx.scanCode({
                        success: (res) => {
                            if (res.errMsg == "scanCode:ok") {
                                ...
                                var url = 'https://' + app.globalData.apiUrl + '?m=home&c=Api&a=updateOwner&pilot_id=' + array[0] + "&can_share_id=" + that.data.can_share_id + "&price=10" + "&user_id=" + app.globalData.userId + "&bookcase_qrcode=" + res.result ;
                                console.log(url)
                                wx.request({
                                    url: url,
                                    method: "GET",
